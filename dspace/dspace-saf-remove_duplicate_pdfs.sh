#!/bin/bash
#
# Remove duplicate PDFs using results from dspace-saf-find_problematic_pdfs.sh script.
#
...
# Example Usage:
#   ```
#   dspace-saf-remove_duplicate_pdfs.sh source_directory duplicates_directory
#   ```
#
...
print_help() {
    ...
    echo_out_e "These \".duplicates\" are generated by the script ${c_n}dspace-saf-find_problematic_pdfs.sh${c_r}."
    echo_out
